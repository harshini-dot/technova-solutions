export const servicesData = [
    { id: 1, title: "Web Development", desc: "Custom, high-performance websites built with modern web technologies." },
    { id: 2, title: "Mobile App Development", desc: "Native and cross-platform apps for iOS and Android platforms." },
    { id: 3, title: "UI/UX Design", desc: "User-centric interfaces designed for seamless navigation and engagement." },
    { id: 4, title: "Cloud Solutions", desc: "Scalable cloud infrastructure and cloud migration services." },
    { id: 5, title: "AI Consulting", desc: "Integrating artificial intelligence and machine learning into business workflows." },
    { id: 6, title: "Digital Marketing", desc: "Data-driven strategies to boost brand visibility and lead growth." },
  ];
  ...
  export const testimonialData = [
    { id: 1, name: "Sarah Jenkins", role: "CTO, AlphaCorp", quote: "TechNova transformed our digital workflow completely. Outstanding delivery speed!" },
    { id: 2, name: "David Chen", role: "Founder, GrowthScale", quote: "Their team built a high-performing product that allowed us to scale rapidly." },
    { id: 3, name: "Elena Rostova", role: "Product Lead, Nexus", quote: "Clear communication, clean architecture, and modern UI execution throughout." },
  ];